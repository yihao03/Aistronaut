@echo off
REM AWS CLI commands to create DynamoDB tables for Aistronaut Travel Booking System
REM Using ON-DEMAND billing mode for cost-effective development/testing
REM Make sure AWS CLI is configured with proper credentials and region
...
REM Table 7: accommodation_bookings
