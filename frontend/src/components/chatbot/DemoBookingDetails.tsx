// src/components/chatbot/DemoBookingDetails.tsx
...
import { DemoBookingDetails as DemoBookingDetailsType } from '../../types';

interface DemoBookingDetailsProps {
  bookingDetails: DemoBookingDetailsType;
...
export default function DemoBookingDetails({ 
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-lg overflow-hidden ml-12 mt-4">
      {/* Header */}
